...
export const Fumarole = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: Fumarole): void {
    __AlgebraicTypeValue.serializeValue(writer, Fumarole.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Fumarole {
    return __AlgebraicTypeValue.deserializeValue(reader, Fumarole.getTypeScriptAlgebraicType());
  },

}

export default Fumarole;
