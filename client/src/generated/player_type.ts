...
export type Player = {
  ...
  hasSeenMemoryShard200Tutorial: boolean,
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    ...
    _cached_Player_type_value.value.elements.push(
      ...
      { name: "isSnorkeling", algebraicType: __AlgebraicTypeValue.Bool },
      ...
      { name: "hasSeenMemoryShard200Tutorial", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenSovaIntro", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenTutorialHint", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenHostileEncounterTutorial", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenRuneStoneTutorial", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenAlkStationTutorial", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "hasSeenCrashedDroneTutorial", algebraicType: __AlgebraicTypeValue.Bool },
      ...
      { name: "isNpc", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "npcRole", algebraicType: __AlgebraicTypeValue.String },
    );
