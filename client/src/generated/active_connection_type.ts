...
let _cached_ActiveConnection_type_value: __AlgebraicTypeType | null = null;
...
export const ActiveConnection = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_ActiveConnection_type_value) return _cached_ActiveConnection_type_value;
    _cached_ActiveConnection_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_ActiveConnection_type_value.value.elements.push(
      { name: "identity", algebraicType: __AlgebraicTypeValue.createIdentityType() },
      { name: "connectionId", algebraicType: __AlgebraicTypeValue.createConnectionIdType() },
      { name: "timestamp", algebraicType: __AlgebraicTypeValue.createTimestampType() },
    );
    return _cached_ActiveConnection_type_value;
  },
