 ...
 */
export class CloudIntensityScheduleTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<CloudIntensitySchedule>;

  constructor(tableCache: __TableCache<CloudIntensitySchedule>) {
