...
export type GrowlPolarBear = { tag: "GrowlPolarBear" };
export type GrowlHare = { tag: "GrowlHare" };
export type GrowlOwl = { tag: "GrowlOwl" };
...
export type SovaMemoryShard200Tutorial = { tag: "SovaMemoryShard200Tutorial" };
...
export type DeathPolarBear = { tag: "DeathPolarBear" };
export type DeathHare = { tag: "DeathHare" };
export type DeathOwl = { tag: "DeathOwl" };
