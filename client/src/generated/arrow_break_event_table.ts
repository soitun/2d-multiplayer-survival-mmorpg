 ...
 */
export class ArrowBreakEventTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<ArrowBreakEvent>;

  constructor(tableCache: __TableCache<ArrowBreakEvent>) {
