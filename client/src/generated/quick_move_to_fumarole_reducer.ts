 ...
 */
export const QuickMoveToFumarole = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: QuickMoveToFumarole): void {
    __AlgebraicTypeValue.serializeValue(writer, QuickMoveToFumarole.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): QuickMoveToFumarole {
    return __AlgebraicTypeValue.deserializeValue(reader, QuickMoveToFumarole.getTypeScriptAlgebraicType());
  },

}

export default QuickMoveToFumarole;
