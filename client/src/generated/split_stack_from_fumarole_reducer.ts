...
let _cached_SplitStackFromFumarole_type_value: __AlgebraicTypeType | null = null;

/**
 * An object for generated helper functions.
 */
export const SplitStackFromFumarole = {
  /**
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    ...
    return _cached_SplitStackFromFumarole_type_value;
  },

  serialize(writer: __BinaryWriter, value: SplitStackFromFumarole): void {
    __AlgebraicTypeValue.serializeValue(writer, SplitStackFromFumarole.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): SplitStackFromFumarole {
    return __AlgebraicTypeValue.deserializeValue(reader, SplitStackFromFumarole.getTypeScriptAlgebraicType());
  },

}

export default SplitStackFromFumarole;
