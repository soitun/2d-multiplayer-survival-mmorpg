...
let _cached_Door_type_value: __AlgebraicTypeType | null = null;
...
export const Door = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_Door_type_value) return _cached_Door_type_value;
    _cached_Door_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_Door_type_value.value.elements.push(
      ...
      { name: "isOpen", algebraicType: __AlgebraicTypeValue.Bool },
    ...
    return _cached_Door_type_value;
  },

  serialize(writer: __BinaryWriter, value: Door): void {
    __AlgebraicTypeValue.serializeValue(writer, Door.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Door {
    return __AlgebraicTypeValue.deserializeValue(reader, Door.getTypeScriptAlgebraicType());
  },
