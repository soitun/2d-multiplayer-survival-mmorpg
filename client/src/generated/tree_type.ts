...
export const Tree = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_Tree_type_value) return _cached_Tree_type_value;
    _cached_Tree_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_Tree_type_value.value.elements.push(
      ...
      { name: "treeType", algebraicType: TreeType.getTypeScriptAlgebraicType() },
  ...
  serialize(writer: __BinaryWriter, value: Tree): void {
    __AlgebraicTypeValue.serializeValue(writer, Tree.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Tree {
    return __AlgebraicTypeValue.deserializeValue(reader, Tree.getTypeScriptAlgebraicType());
  },
