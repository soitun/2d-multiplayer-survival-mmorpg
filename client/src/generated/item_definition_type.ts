...
export type ItemDefinition = {
  ...
  requiresFurnaceForCooking: boolean,
  extractionOutputName: string | undefined,
  extractionOutputMin: number | undefined,
  extractionOutputMax: number | undefined,
  extractionActionLabel: string | undefined,
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    ...
    _cached_ItemDefinition_type_value.value.elements.push(
      ...
      { name: "requiresFurnaceForCooking", algebraicType: __AlgebraicTypeValue.Bool },
      { name: "extractionOutputName", algebraicType: __AlgebraicTypeValue.createOptionType(__AlgebraicTypeValue.String) },
      { name: "extractionOutputMin", algebraicType: __AlgebraicTypeValue.createOptionType(__AlgebraicTypeValue.U32) },
      { name: "extractionOutputMax", algebraicType: __AlgebraicTypeValue.createOptionType(__AlgebraicTypeValue.U32) },
      { name: "extractionActionLabel", algebraicType: __AlgebraicTypeValue.createOptionType(__AlgebraicTypeValue.String) },
