...
export function drawMinimapOntoCanvas({
  ...
  // NOTE: Wolf Den label intentionally removed - it's a minor monument (wolf spawn point)
  // Players will discover wolf dens naturally through gameplay, not the minimap
