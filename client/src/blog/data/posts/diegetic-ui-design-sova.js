export default {
  ...
  content: `
    ...
    <h2>🦉 Meet SOVA: Your Sentient Ocular Virtual Assistant</h2>

    <p>In the Babushka universe, your character isn't just a survivor with good eyesight. You're a bioelectrically enhanced operative with ocular implants that project hardlight overlays directly into your field of vision. Your AI companion, <strong>SOVA</strong> (Sentient Ocular Virtual Assistant), interprets the world for you.</p>

    <p>That health bar? It's SOVA monitoring your vitals. The inventory grid? SOVA cataloging your belongings. The minimap? A cached satellite feed that SOVA projects into your occipital lobe. Every piece of UI has a reason to exist because SOVA makes it exist.</p>

    <p>This isn't just flavor text. It fundamentally changes how we design interactions.</p>
    ...
    <h2>🗿 Cairns: Ancient Machine Learning in Stone</h2>

    <p>Scattered across the island, cairn monuments mark the graves of those who came before. But why does tapping on a pile of rocks reveal lore?</p>

    <p>Because the previous inhabitants didn't just stack stones. They <strong>carved machine learning weights directly into the rock itself</strong> - encoded patterns that your on-board AI can scan, download, and interpret as data. The cairns are ancient USB drives, and SOVA is the reader.</p>

    <p>Each cairn reveals fragments of what happened on this island before you arrived - war, experiments, factions fighting for control. The lore isn't in a codex you find. It's physically embedded in the world.</p>
    ...
    <p>Need to learn how to build a workbench? You don't find instructions. You absorb enough Memory Shards to let SOVA synthesize the knowledge directly into your neural pathways. It's not magic - it's technology that feels real within the world.</p>

    <h2>🧠 The Memory Grid: Factions of the Babushka Universe</h2>

    <p>The Memory Grid isn't just a skill tree – it's a window into the broader Babushka universe. As you accumulate Memory Shards, you can unlock faction-specific knowledge from the major powers of Gred:</p>

    <ul>
      <li><strong>Black Wolves</strong> - Enforcer branch. Brutal efficiency through superior firepower.</li>
      <li><strong>Hive</strong> - Chem-Industrial branch. Evolution through chemical mastery.</li>
      <li><strong>University</strong> - Robotics & Fabrication branch. Knowledge as the ultimate weapon.</li>
      <li><strong>Data Angels</strong> - Cyber & Stealth branch. Information warfare in the digital age.</li>
      <li><strong>Battalion</strong> - Conventional Military branch. Disciplined force multipliers.</li>
      <li><strong>Admiralty</strong> - Weather & Coastal Mastery branch. Masters of sea and storm.</li>
    </ul>

    <p>Each faction offers unique buildings, abilities, and passive bonuses. Choose carefully - the knowledge you absorb shapes the survivor you become.</p>
    ...
    <p>Every game makes compromises between immersion and usability. Diegetic UI isn't always the answer - sometimes a floating health bar is just cleaner.</p>

    <p>But when you commit to it, something magical happens. Players stop thinking about "the interface" and start thinking about "my neural implant." They don't "check the map" - they "activate SOVA's projection." The game world feels more real because the UI respects that reality.</p>
