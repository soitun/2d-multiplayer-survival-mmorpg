...
const TUTORIALS = {
    crashIntro: {
        ...
        message: `Neural link established. This is SOVA — Sentient Ocular Virtual Assistant — your tactical AI implant from Gred Naval Intelligence. I've been offline since the Sovereign Tide went down. Based on your biometrics, you've been unconscious for... a while. The icebreaker's gone. Most of the crew... didn't make it. You're on an uncharted island in contested waters, and your survival is now my primary directive. The wreckage scattered supplies across the shoreline. Find food, water, shelter. Everything else can wait. For now, just stay alive.`,
    },
    tutorialHint: {
