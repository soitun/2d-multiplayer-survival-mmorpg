...
pub fn check_monument_zone_placement(ctx: &ReducerContext, world_x: f32, world_y: f32) -> Result<(), String> {
    ...
    let fishing_village_parts = ctx.db.fishing_village_part();
    for part in fishing_village_parts.iter() {
        // Only check against the campfire (center piece) for simplicity
    ...
    for part in shipwreck_parts.iter() {
