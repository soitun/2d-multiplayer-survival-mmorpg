...
pub fn get_tool_definitions() -> Vec<ItemDefinition> {
    vec![
        ...
        ItemBuilder::new("Bone Carving Kit", "An ancient Unangan carving kit containing traditional bone-working tools: a curved adze, serrated scrapers, and polishing stones.", ItemCategory::Tool)
            ...
            ItemBuilder::new("Transistor Radio", "A weathered Soviet-era transistor radio, its red casing faded by salt air. Salvaged from the crashed research drone wreckage.", ItemCategory::Tool)
            .icon("radio.png")
