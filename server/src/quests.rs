...
fn seed_tutorial_quests(ctx: &ReducerContext) -> Result<(), String> {
    ...
    let quests = vec![
        ...
        TutorialQuestDefinition {
            ...
            description: "Craft a Hunting Bow and craft Wooden Arrows 5 times.".to_string(),
            objective_type: QuestObjectiveType::CraftSpecificItem,
            target_id: Some("Hunting Bow".to_string()),
            target_amount: 1,
            secondary_objective_type: Some(QuestObjectiveType::CraftSpecificItem),
            secondary_target_id: Some("Wooden Arrow".to_string()),
            ...
            shard_reward: 15,
            unlock_recipe: None,
            sova_start_message: "Before you hunt, you need proper weapons. Craft a Hunting Bow and make 5 batches of Wooden Arrows. The bow is essential for ranged combat - safer than getting up close with dangerous animals.".to_string(),
            ...
            sova_hint_message: "Press B to open crafting. Craft the Hunting Bow first, then craft Wooden Arrows 5 times. Both objectives must be completed.".to_string(),
        },
...
fn seed_daily_quests(ctx: &ReducerContext) -> Result<(), String> {
    ...
    let quests = vec![
        ...
        DailyQuestDefinition {
            id: "daily_kill_wolverines".to_string(),
            name: "Wolverwine Slayer".to_string(),
            description: "Kill 3 wolverines.".to_string(),
            objective_type: QuestObjectiveType::KillSpecificAnimal,
            target_id: Some("Wolverine".to_string()),
            target_amount: 3,
